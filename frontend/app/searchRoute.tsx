...
import { useDeleteSavedLocationMutation, useLocationSearchQuery, useSavedLocationsQuery, useSaveLocationMutation } from "@/hook/useLocations";
...
export default function SearchRoute() {
    const {userSearch, setUserSearch, destination, setDestination, origin} = useRouteContext();
    const {data: searchData, isLoading: isSearching, error: searchError} = useLocationSearchQuery(userSearch)
    ...
    return <View style={styles.screen}>
        <SafeAreaView style={{flex: 1}}>
            ...
            <SearchBar searchContent={userSearch} 
            ...
            {!isSearching && userSearch.trim().length >= 2 && locations.length === 0 && (
            ...
            <FlatList 
                ...
                return (<CardItem mainIcon={icons.no_image}
                        cardTitle={item.name}
